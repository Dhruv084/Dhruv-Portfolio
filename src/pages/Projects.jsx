...
const PROJECTS = [
  {
    ...
    desc: 'A full-stack web application for managing college documents efficiently. Built with modern technologies to streamline document organization, storage, and retrieval for educational institutions.',
    ss: '/Document_image.jpg',
    ...
    >
      <div className="card" style={{ background: 'rgba(255,255,255,0.03)', borderRadius: 16, padding: 30 }}>
        ...
        <p className="text-gray-400 mb-10">
          A collection of my major works — blending creativity and technology.
        </p>
