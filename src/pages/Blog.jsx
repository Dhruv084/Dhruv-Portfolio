  ...
  const defaultPosts = [
    {
      ...
      text: "Modern web applications require speed and scalability. Using React and Next.js, I build fast, optimized, and user-friendly applications.",
    },
    {
      id: 2,
      title: "Why I Use React",
      text: "React simplifies UI development through reusable components. It helps me create clean, interactive, and efficient user experiences.",
    },
    {
      id: 3,
      title: "My Full Stack Journey",
      text: "I started with frontend development and gradually explored backend technologies and APIs. Now, I enjoy building complete applications from database to user interface.",
    },
  ];
